...
class Server {
  ...
  setupMiddleware() {
    // Configure CORS
    const corsOptions = {
      origin: ['*','https://abhishek12221732.github.io', 'http://localhost:3000', 'https://law-aware.onrender.com/', "https://law-aware-frontend.onrender.com"], // Add localhost for testing
      credentials: true,
